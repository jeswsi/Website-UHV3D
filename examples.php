            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-heading">
                        <h2>Example Products from UHV3D</h2>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="feature-item">
                                    ...
                                    <p class="text-muted">RFA Probe Head Design</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="feature-item">
                                    ...
                                    <p class="text-muted">Optimizing Design for Heat Load</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="feature-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="feature-item">
                                    <!-- <i class="icon-screen-smartphone text-primary"></i> -->
                                    <img src="img/Beam_Dump_Section_Small.png">
                                    <p class="text-muted">Beam Dump Design</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="feature-item">
                                    <img src="img/Zemax_analysis_small.PNG">
                                    <p class="text-muted">Light Reduction Analysis in Zemax</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="feature-item">
                                    <img src="img/beam_dump_printed.jpg">
                                    <p class="text-muted">3D Printed Beam Dump</p>
                                </div>
                            </div>
